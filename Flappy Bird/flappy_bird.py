# Flappy bird made in Python 3 with Turtle module
# Original source: https://www.youtube.com/watch?v=zaD6TsM6Pj8
...
window.title("Flappy Bird by RafaelxFernandes")
